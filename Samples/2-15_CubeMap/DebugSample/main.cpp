...
int main()
{
    ...
    // - Copy buffer to image;
    {
        ...
        for (uint32_t i = 0; i < 6; i++)
        {
            ...
            hdrBufToImgCopies[i].bufferRowLength = width;
            hdrBufToImgCopies[i].bufferImageHeight = height;
            ...
            hdrBufToImgCopies[i].bufferOffset = i * (width / 6) * sizeof(float) * 3;
        }
