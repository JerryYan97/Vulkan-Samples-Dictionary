...
int main()
{
    ...
    VkApplicationInfo appInfo{}; // TIPS: You can delete this bracket to see what happens.
    {
        ...
        appInfo.pApplicationName = "InitPipeline";
    ...
    std::string shaderVertPath = std::string(SOURCE_PATH) + std::string("/init_pipeline.vert.spv");
    ...
    //                              the CMakeLists.txt file in the same level of repository.
    std::string shaderFragPath = std::string(SOURCE_PATH) + std::string("/init_pipeline.frag.spv");
