...
int main()
{
    ...
    // Create Image
    VkFormat depthImgFormat = VK_FORMAT_D16_UNORM;
    VkImageTiling depthBufTiling;
    {
        ...
        {
            std::cout << "VK_FORMAT_D16_UNORM Unsupported." << std::endl;
            exit(1);
        }
    }
    VkImageCreateInfo imageInfo{};
    {
        ...
        imageInfo.format = depthImgFormat;
        ...
        imageInfo.tiling = depthBufTiling;
    }
    VkImage depthImage;
    ...
    vkBindImageMemory(device, depthImage, imageMem, 0);
    ...
    VkImageViewCreateInfo imageViewInfo{};
    {
        ...
        imageViewInfo.format = depthImgFormat;
    ...
    vkCreateImageView(device, &imageViewInfo, nullptr, &depthImgView);
